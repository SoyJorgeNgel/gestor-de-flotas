...
A raíz de esta situación y contando con otras opciones viables para la titulación, el proyecto no recibió funcionalidades adicionales que se tenían contempladas, tales como:

Localización en tiempo real de las unidades.

Consulta de APIs para el pronóstico del clima.

Integración con Google Maps para la optimización de rutas y cálculo de tiempos de viaje.

Confirmación por parte de los choferes sobre la entrega exitosa de la mercancía en destino.
